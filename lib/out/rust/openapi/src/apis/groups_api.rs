...
pub async fn create_group(configuration: &configuration::Configuration, group_write_model: Option<models::GroupWriteModel>) -> Result<models::GroupModel, Error<CreateGroupError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&group_write_model);
...
pub async fn delete_group(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteGroupError>> {
    ...
    let local_var_uri_str = format!("{}/api/v3/groups/{id}", local_var_configuration.base_path, id=id);
...
pub async fn get_group(configuration: &configuration::Configuration, id: i32) -> Result<models::GroupModel, Error<GetGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn list_groups(configuration: &configuration::Configuration, sort_by: Option<&str>, select: Option<&str>) -> Result<models::GroupCollectionModel, Error<ListGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_group(configuration: &configuration::Configuration, id: i32, group_write_model: Option<models::GroupWriteModel>) -> Result<models::GroupModel, Error<UpdateGroupError>> {
    let local_var_configuration = configuration;
