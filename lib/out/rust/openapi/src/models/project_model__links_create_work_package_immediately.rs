...
pub struct ProjectModelLinksCreateWorkPackageImmediately {
...
impl ProjectModelLinksCreateWorkPackageImmediately {
    pub fn new(href: Option<serde_json::Value>) -> ProjectModelLinksCreateWorkPackageImmediately {
