...
pub struct StorageReadModelLinksOpen {
...
impl StorageReadModelLinksOpen {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksOpen {
        StorageReadModelLinksOpen {
            href,
            title: None,
            templated: None,
            method: None,
