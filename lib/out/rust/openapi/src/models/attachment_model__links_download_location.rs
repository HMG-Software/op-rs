...
pub struct AttachmentModelLinksDownloadLocation {
...
impl AttachmentModelLinksDownloadLocation {
    pub fn new(href: Option<serde_json::Value>) -> AttachmentModelLinksDownloadLocation {
