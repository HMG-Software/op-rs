...
pub struct WorkPackageModelLinksTimeEntries {
...
impl WorkPackageModelLinksTimeEntries {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksTimeEntries {
