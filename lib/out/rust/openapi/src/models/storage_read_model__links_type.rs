...
pub struct StorageReadModelLinksType {
...
impl StorageReadModelLinksType {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksType {
        StorageReadModelLinksType {
            href,
            title: None,
            templated: None,
            method: None,
