...
pub struct ProjectStorageModelLinksOpen {
...
impl ProjectStorageModelLinksOpen {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksOpen {
        ProjectStorageModelLinksOpen {
            href,
            title: None,
            templated: None,
            method: None,
