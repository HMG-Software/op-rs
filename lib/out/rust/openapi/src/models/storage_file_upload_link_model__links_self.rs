...
pub struct StorageFileUploadLinkModelLinksSelf {
...
impl StorageFileUploadLinkModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> StorageFileUploadLinkModelLinksSelf {
