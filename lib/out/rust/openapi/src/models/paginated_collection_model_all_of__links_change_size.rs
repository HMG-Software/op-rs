...
pub struct PaginatedCollectionModelAllOfLinksChangeSize {
...
impl PaginatedCollectionModelAllOfLinksChangeSize {
    pub fn new(href: Option<serde_json::Value>) -> PaginatedCollectionModelAllOfLinksChangeSize {
        PaginatedCollectionModelAllOfLinksChangeSize {
            href,
            title: None,
            templated: None,
            method: None,
