...
impl PlaceholderUserCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::PlaceholderUserCollectionModelAllOfLinks, _embedded: models::PlaceholderUserCollectionModelAllOfEmbedded) -> PlaceholderUserCollectionModel {
