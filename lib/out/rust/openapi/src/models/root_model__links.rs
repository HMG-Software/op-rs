...
impl RootModelLinks {
    pub fn new(param_self: models::RootModelLinksSelf, configuration: models::RootModelLinksConfiguration, memberships: models::RootModelLinksMemberships, priorities: models::RootModelLinksPriorities, relations: models::RootModelLinksRelations, statuses: models::RootModelLinksStatuses, time_entries: models::RootModelLinksTimeEntries, types: models::RootModelLinksTypes, user: models::RootModelLinksUser, user_preferences: models::RootModelLinksUserPreferences, work_packages: models::RootModelLinksWorkPackages) -> RootModelLinks {
        RootModelLinks {
