...
impl RelationModelLinks {
    pub fn new(param_self: models::RelationModelLinksSelf, schema: models::RelationModelLinksSchema, from: models::RelationModelLinksFrom, to: models::RelationModelLinksTo) -> RelationModelLinks {
        RelationModelLinks {
            update: None,
