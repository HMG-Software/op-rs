...
pub struct WorkPackageModelLinksResponsible {
...
impl WorkPackageModelLinksResponsible {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksResponsible {
