...
pub struct UserModelAllOfLinksDelete {
...
impl UserModelAllOfLinksDelete {
    pub fn new(href: Option<serde_json::Value>) -> UserModelAllOfLinksDelete {
        UserModelAllOfLinksDelete {
            href,
            title: None,
            templated: None,
            method: None,
