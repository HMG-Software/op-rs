...
pub struct WorkPackageModelLinksChildrenInner {
...
impl WorkPackageModelLinksChildrenInner {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksChildrenInner {
