...
pub struct ProjectStorageModelLinksOpenWithConnectionEnsured {
...
impl ProjectStorageModelLinksOpenWithConnectionEnsured {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksOpenWithConnectionEnsured {
        ProjectStorageModelLinksOpenWithConnectionEnsured {
            href,
            title: None,
            templated: None,
            method: None,
