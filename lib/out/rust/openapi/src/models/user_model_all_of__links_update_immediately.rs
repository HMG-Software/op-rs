...
pub struct UserModelAllOfLinksUpdateImmediately {
...
impl UserModelAllOfLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> UserModelAllOfLinksUpdateImmediately {
