...
pub struct PlaceholderUserModelAllOfLinksDelete {
...
impl PlaceholderUserModelAllOfLinksDelete {
    pub fn new(href: Option<serde_json::Value>) -> PlaceholderUserModelAllOfLinksDelete {
        PlaceholderUserModelAllOfLinksDelete {
            href,
            title: None,
            templated: None,
            method: None,
