...
pub struct MembershipReadModelEmbeddedPrincipal {
...
impl MembershipReadModelEmbeddedPrincipal {
    pub fn new(_type: Option<Type>, id: Option<serde_json::Value>, name: Option<serde_json::Value>, _links: models::UserModelAllOfLinks, avatar: Option<serde_json::Value>) -> MembershipReadModelEmbeddedPrincipal {
