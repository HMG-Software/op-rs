...
pub struct WorkPackageModelLinksAvailableWatchers {
...
impl WorkPackageModelLinksAvailableWatchers {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAvailableWatchers {
