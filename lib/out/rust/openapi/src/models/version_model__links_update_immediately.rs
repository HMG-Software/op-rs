...
pub struct VersionModelLinksUpdateImmediately {
...
impl VersionModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> VersionModelLinksUpdateImmediately {
