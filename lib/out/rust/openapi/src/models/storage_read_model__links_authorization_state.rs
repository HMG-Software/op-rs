...
pub struct StorageReadModelLinksAuthorizationState {
...
impl StorageReadModelLinksAuthorizationState {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksAuthorizationState {
        StorageReadModelLinksAuthorizationState {
            href,
            title: None,
            templated: None,
            method: None,
