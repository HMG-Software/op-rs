...
pub struct UserModelAllOfLinksUnlock {
...
impl UserModelAllOfLinksUnlock {
    pub fn new(href: Option<serde_json::Value>) -> UserModelAllOfLinksUnlock {
        UserModelAllOfLinksUnlock {
            href,
            title: None,
            templated: None,
            method: None,
