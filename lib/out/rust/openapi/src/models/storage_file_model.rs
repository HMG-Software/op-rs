...
pub struct StorageFileModel {
    ...
    #[serde(rename = "lastModifiedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub last_modified_at: Option<Option<serde_json::Value>>,
    /// Display name of the author that created the file on the origin
    #[serde(rename = "createdByName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub created_by_name: Option<Option<serde_json::Value>>,
    /// Display name of the author that modified the file on the origin last
    #[serde(rename = "lastModifiedByName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl StorageFileModel {
    pub fn new(id: Option<serde_json::Value>, name: Option<serde_json::Value>, _type: Type, location: String, _links: models::StorageFileModelAllOfLinks) -> StorageFileModel {
        StorageFileModel {
            id,
            name,
            mime_type: None,
