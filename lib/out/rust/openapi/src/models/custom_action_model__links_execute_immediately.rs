...
pub struct CustomActionModelLinksExecuteImmediately {
...
impl CustomActionModelLinksExecuteImmediately {
    pub fn new(href: Option<serde_json::Value>) -> CustomActionModelLinksExecuteImmediately {
