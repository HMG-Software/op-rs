...
pub struct ProjectModelLinksUpdateImmediately {
...
impl ProjectModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> ProjectModelLinksUpdateImmediately {
