...
pub struct QueryFilterInstanceSchemaModelLinksFilter {
...
impl QueryFilterInstanceSchemaModelLinksFilter {
    pub fn new(href: Option<serde_json::Value>) -> QueryFilterInstanceSchemaModelLinksFilter {
