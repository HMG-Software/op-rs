...
pub struct MembershipWriteModelLinksPrincipal {
...
impl MembershipWriteModelLinksPrincipal {
    pub fn new(href: Option<serde_json::Value>) -> MembershipWriteModelLinksPrincipal {
