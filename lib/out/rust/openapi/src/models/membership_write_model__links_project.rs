...
pub struct MembershipWriteModelLinksProject {
...
impl MembershipWriteModelLinksProject {
    pub fn new(href: Option<serde_json::Value>) -> MembershipWriteModelLinksProject {
