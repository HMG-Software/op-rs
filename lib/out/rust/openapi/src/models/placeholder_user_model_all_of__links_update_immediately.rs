...
pub struct PlaceholderUserModelAllOfLinksUpdateImmediately {
...
impl PlaceholderUserModelAllOfLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> PlaceholderUserModelAllOfLinksUpdateImmediately {
        PlaceholderUserModelAllOfLinksUpdateImmediately {
            href,
            title: None,
            templated: None,
            method: None,
