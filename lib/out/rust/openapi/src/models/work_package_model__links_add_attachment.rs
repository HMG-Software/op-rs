...
pub struct WorkPackageModelLinksAddAttachment {
...
impl WorkPackageModelLinksAddAttachment {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAddAttachment {
