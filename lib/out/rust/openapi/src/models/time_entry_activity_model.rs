...
impl TimeEntryActivityModel {
    pub fn new(_type: Type, id: i32, name: String, position: i32, default: bool, _embedded: models::TimeEntryActivityModelEmbedded, _links: models::TimeEntryActivityModelLinks) -> TimeEntryActivityModel {
