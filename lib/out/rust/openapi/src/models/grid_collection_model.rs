...
pub struct GridCollectionModel {
    ...
    pub _embedded: Box<models::GridCollectionModelAllOfEmbedded>,
}

impl GridCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::PaginatedCollectionModelAllOfLinks, page_size: Option<serde_json::Value>, offset: Option<serde_json::Value>, _embedded: models::GridCollectionModelAllOfEmbedded) -> GridCollectionModel {
        GridCollectionModel {
            _type,
            total,
            count,
