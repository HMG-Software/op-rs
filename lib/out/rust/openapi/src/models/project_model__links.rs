...
pub struct ProjectModelLinks {
    ...
    #[serde(rename = "createWorkPackageImmediately", skip_serializing_if = "Option::is_none")]
    pub create_work_package_immediately: Option<Box<models::ProjectModelLinksCreateWorkPackageImmediately>>,
    #[serde(rename = "self")]
...
impl ProjectModelLinks {
    pub fn new(param_self: models::ProjectModelLinksSelf, categories: models::ProjectModelLinksCategories, types: models::ProjectModelLinksTypes, versions: models::ProjectModelLinksVersions, memberships: models::ProjectModelLinksMemberships, work_packages: models::ProjectModelLinksWorkPackages) -> ProjectModelLinks {
        ProjectModelLinks {
            update: None,
