...
impl StorageFilesModelParent {
    pub fn new(id: Option<serde_json::Value>, name: Option<serde_json::Value>, _type: Option<Type>, location: Option<serde_json::Value>, _links: models::StorageFileModelAllOfLinks) -> StorageFilesModelParent {
