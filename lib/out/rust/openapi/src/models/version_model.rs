...
pub struct VersionModel {
    ...
    pub description: Option<Box<models::ActivityModelComment>>,
...
impl VersionModel {
    pub fn new(name: String, status: String, sharing: String, created_at: String, updated_at: String) -> VersionModel {
        VersionModel {
            id: None,
            name,
            description: None,
