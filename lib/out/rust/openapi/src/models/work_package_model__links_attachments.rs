...
pub struct WorkPackageModelLinksAttachments {
...
impl WorkPackageModelLinksAttachments {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAttachments {
