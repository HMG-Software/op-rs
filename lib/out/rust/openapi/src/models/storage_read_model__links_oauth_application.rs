...
pub struct StorageReadModelLinksOauthApplication {
...
impl StorageReadModelLinksOauthApplication {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksOauthApplication {
        StorageReadModelLinksOauthApplication {
            href,
            title: None,
            templated: None,
            method: None,
