...
pub struct MembershipReadModelLinksUpdateImmediately {
...
impl MembershipReadModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> MembershipReadModelLinksUpdateImmediately {
        MembershipReadModelLinksUpdateImmediately {
            href,
            title: None,
            templated: None,
            method: None,
