...
pub struct ProjectModelLinksProjectStorages {
...
impl ProjectModelLinksProjectStorages {
    pub fn new(href: Option<serde_json::Value>) -> ProjectModelLinksProjectStorages {
