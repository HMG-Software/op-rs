...
pub struct MembershipReadModelLinksSelf {
...
impl MembershipReadModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> MembershipReadModelLinksSelf {
        MembershipReadModelLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
