...
pub struct FileLinkReadModelLinksOriginOpen {
...
impl FileLinkReadModelLinksOriginOpen {
    pub fn new(href: Option<serde_json::Value>) -> FileLinkReadModelLinksOriginOpen {
