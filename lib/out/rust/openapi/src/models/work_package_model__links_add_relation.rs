...
pub struct WorkPackageModelLinksAddRelation {
...
impl WorkPackageModelLinksAddRelation {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAddRelation {
