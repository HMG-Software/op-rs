...
pub struct GridReadModelLinksUpdateImmediately {
...
impl GridReadModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> GridReadModelLinksUpdateImmediately {
