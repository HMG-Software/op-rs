...
pub struct WatchersModelAllOfEmbeddedElementsInner {
    ...
    #[serde(rename = "identityUrl", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub identity_url: Option<Option<serde_json::Value>>,
}

impl WatchersModelAllOfEmbeddedElementsInner {
    pub fn new(_type: Option<Type>, id: Option<serde_json::Value>, name: Option<serde_json::Value>, _links: models::UserModelAllOfLinks, avatar: Option<serde_json::Value>) -> WatchersModelAllOfEmbeddedElementsInner {
        WatchersModelAllOfEmbeddedElementsInner {
            _type,
            id,
            name,
            created_at: None,
