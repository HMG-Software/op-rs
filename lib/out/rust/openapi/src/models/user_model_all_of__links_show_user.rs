...
pub struct UserModelAllOfLinksShowUser {
...
impl UserModelAllOfLinksShowUser {
    pub fn new(href: Option<serde_json::Value>) -> UserModelAllOfLinksShowUser {
        UserModelAllOfLinksShowUser {
            href,
            title: None,
            templated: None,
            method: None,
