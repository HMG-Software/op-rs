...
pub struct GridReadModelLinksAddAttachment {
...
impl GridReadModelLinksAddAttachment {
    pub fn new(href: Option<serde_json::Value>) -> GridReadModelLinksAddAttachment {
        GridReadModelLinksAddAttachment {
            href,
            title: None,
            templated: None,
            method: None,
