...
pub struct ProjectCollectionModelAllOfLinksRepresentationsInner {
    ...
    #[serde(rename = "templated", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ProjectCollectionModelAllOfLinksRepresentationsInner {
    pub fn new(href: Option<serde_json::Value>) -> ProjectCollectionModelAllOfLinksRepresentationsInner {
        ProjectCollectionModelAllOfLinksRepresentationsInner {
            href,
            title: None,
            templated: None,
            method: None,
