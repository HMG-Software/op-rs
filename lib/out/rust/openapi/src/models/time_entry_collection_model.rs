...
impl TimeEntryCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::TimeEntryCollectionModelAllOfLinks, _embedded: models::TimeEntryCollectionModelAllOfEmbedded) -> TimeEntryCollectionModel {
