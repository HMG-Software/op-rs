...
pub struct OAuthApplicationReadModelLinksSelf {
...
impl OAuthApplicationReadModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> OAuthApplicationReadModelLinksSelf {
