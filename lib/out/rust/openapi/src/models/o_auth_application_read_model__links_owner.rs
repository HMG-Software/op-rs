...
pub struct OAuthApplicationReadModelLinksOwner {
...
impl OAuthApplicationReadModelLinksOwner {
    pub fn new(href: Option<serde_json::Value>) -> OAuthApplicationReadModelLinksOwner {
        OAuthApplicationReadModelLinksOwner {
            href,
            title: None,
            templated: None,
            method: None,
