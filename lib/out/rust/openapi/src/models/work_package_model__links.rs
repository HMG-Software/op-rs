...
impl WorkPackageModelLinks {
    pub fn new(param_self: models::WorkPackageModelLinksSelf, schema: models::WorkPackageModelLinksSchema, ancestors: Vec<models::WorkPackageModelLinksAncestorsInner>, attachments: models::WorkPackageModelLinksAttachments, author: models::WorkPackageModelLinksAuthor, children: Vec<models::WorkPackageModelLinksChildrenInner>, priority: models::WorkPackageModelLinksPriority, project: models::WorkPackageModelLinksProject, status: models::WorkPackageModelLinksStatus, r#type: models::WorkPackageModelLinksType) -> WorkPackageModelLinks {
