...
pub struct MembershipFormModelLinksValidateInner {
...
impl MembershipFormModelLinksValidateInner {
    pub fn new(href: Option<serde_json::Value>) -> MembershipFormModelLinksValidateInner {
        MembershipFormModelLinksValidateInner {
            href,
            title: None,
            templated: None,
            method: None,
