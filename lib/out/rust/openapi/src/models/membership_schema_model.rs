...
pub struct MembershipSchemaModel {
    ...
    #[serde(rename = "_dependencies", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl MembershipSchemaModel {
    pub fn new(_type: Option<Type>, _links: models::SchemaModelLinks, id: models::SchemaPropertyModel, created_at: models::SchemaPropertyModel, updated_at: models::SchemaPropertyModel, notification_message: models::SchemaPropertyModel, project: models::SchemaPropertyModel, principal: models::SchemaPropertyModel, roles: models::SchemaPropertyModel) -> MembershipSchemaModel {
