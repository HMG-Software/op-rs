...
pub struct PrincipalCollectionModelAllOfLinksSelf {
...
impl PrincipalCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> PrincipalCollectionModelAllOfLinksSelf {
        PrincipalCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
