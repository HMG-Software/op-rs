...
impl TimeEntryModelLinks {
    pub fn new(param_self: models::TimeEntryModelLinksSelf, project: models::TimeEntryModelLinksProject, user: models::TimeEntryModelLinksUser, activity: models::TimeEntryModelLinksActivity) -> TimeEntryModelLinks {
        TimeEntryModelLinks {
