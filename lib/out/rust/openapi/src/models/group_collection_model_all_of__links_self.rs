...
pub struct GroupCollectionModelAllOfLinksSelf {
...
impl GroupCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> GroupCollectionModelAllOfLinksSelf {
        GroupCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
