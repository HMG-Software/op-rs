...
pub struct TimeEntryModelLinksUpdateImmediately {
...
impl TimeEntryModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> TimeEntryModelLinksUpdateImmediately {
