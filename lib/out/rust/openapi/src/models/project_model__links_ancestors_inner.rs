...
pub struct ProjectModelLinksAncestorsInner {
...
impl ProjectModelLinksAncestorsInner {
    pub fn new(href: Option<serde_json::Value>) -> ProjectModelLinksAncestorsInner {
        ProjectModelLinksAncestorsInner {
            href,
            title: None,
            templated: None,
            method: None,
