...
pub struct FileLinkReadModelLinksStatus {
...
impl FileLinkReadModelLinksStatus {
    pub fn new(href: Option<serde_json::Value>) -> FileLinkReadModelLinksStatus {
        FileLinkReadModelLinksStatus {
            href,
            title: None,
            templated: None,
            method: None,
