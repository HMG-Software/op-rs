...
pub struct VersionModelLinksAvailableInProjects {
...
impl VersionModelLinksAvailableInProjects {
    pub fn new(href: Option<serde_json::Value>) -> VersionModelLinksAvailableInProjects {
