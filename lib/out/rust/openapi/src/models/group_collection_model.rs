...
pub struct GroupCollectionModel {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::GroupCollectionModelAllOfLinks>,
    #[serde(rename = "_embedded")]
    pub _embedded: Box<models::GroupCollectionModelAllOfEmbedded>,
}

impl GroupCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::GroupCollectionModelAllOfLinks, _embedded: models::GroupCollectionModelAllOfEmbedded) -> GroupCollectionModel {
