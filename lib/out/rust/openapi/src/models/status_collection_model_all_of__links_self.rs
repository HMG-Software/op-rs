...
pub struct StatusCollectionModelAllOfLinksSelf {
...
impl StatusCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> StatusCollectionModelAllOfLinksSelf {
        StatusCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
