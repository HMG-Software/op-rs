...
pub struct ProjectModelLinksCreateWorkPackage {
...
impl ProjectModelLinksCreateWorkPackage {
    pub fn new(href: Option<serde_json::Value>) -> ProjectModelLinksCreateWorkPackage {
