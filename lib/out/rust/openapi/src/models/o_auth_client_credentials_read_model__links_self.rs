...
pub struct OAuthClientCredentialsReadModelLinksSelf {
...
impl OAuthClientCredentialsReadModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> OAuthClientCredentialsReadModelLinksSelf {
        OAuthClientCredentialsReadModelLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
