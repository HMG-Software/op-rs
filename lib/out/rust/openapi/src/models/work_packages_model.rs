...
pub struct WorkPackagesModel {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::WorkPackagesModelAllOfLinks>,
    #[serde(rename = "_embedded")]
    pub _embedded: Box<models::WorkPackagesModelAllOfEmbedded>,
}

impl WorkPackagesModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::WorkPackagesModelAllOfLinks, _embedded: models::WorkPackagesModelAllOfEmbedded) -> WorkPackagesModel {
        WorkPackagesModel {
            _type,
            total,
            count,
