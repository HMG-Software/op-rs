...
pub struct GridReadModelLinksUpdate {
...
impl GridReadModelLinksUpdate {
    pub fn new(href: Option<serde_json::Value>) -> GridReadModelLinksUpdate {
        GridReadModelLinksUpdate {
            href,
            title: None,
            templated: None,
            method: None,
