...
pub struct CustomActionModelLinksSelf {
...
impl CustomActionModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> CustomActionModelLinksSelf {
        CustomActionModelLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
