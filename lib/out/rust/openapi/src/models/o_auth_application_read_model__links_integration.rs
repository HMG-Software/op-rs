...
pub struct OAuthApplicationReadModelLinksIntegration {
...
impl OAuthApplicationReadModelLinksIntegration {
    pub fn new(href: Option<serde_json::Value>) -> OAuthApplicationReadModelLinksIntegration {
