...
pub struct NotificationCollectionModelAllOfLinksJumpTo {
...
impl NotificationCollectionModelAllOfLinksJumpTo {
    pub fn new(href: Option<serde_json::Value>) -> NotificationCollectionModelAllOfLinksJumpTo {
        NotificationCollectionModelAllOfLinksJumpTo {
            href,
            title: None,
            templated: None,
            method: None,
