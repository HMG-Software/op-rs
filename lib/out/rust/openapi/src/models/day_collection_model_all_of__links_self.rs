...
pub struct DayCollectionModelAllOfLinksSelf {
...
impl DayCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> DayCollectionModelAllOfLinksSelf {
