...
pub struct TimeEntryActivityModelLinksProjectsInner {
...
impl TimeEntryActivityModelLinksProjectsInner {
    pub fn new(href: Option<serde_json::Value>) -> TimeEntryActivityModelLinksProjectsInner {
        TimeEntryActivityModelLinksProjectsInner {
            href,
            title: None,
            templated: None,
            method: None,
