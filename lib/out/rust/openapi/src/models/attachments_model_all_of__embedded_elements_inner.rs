...
pub struct AttachmentsModelAllOfEmbeddedElementsInner {
    ...
    pub description: Box<models::AttachmentModelDescription>,
...
impl AttachmentsModelAllOfEmbeddedElementsInner {
    pub fn new(title: Option<serde_json::Value>, file_name: Option<serde_json::Value>, description: models::AttachmentModelDescription, content_type: Option<serde_json::Value>, digest: Option<serde_json::Value>, created_at: Option<serde_json::Value>) -> AttachmentsModelAllOfEmbeddedElementsInner {
