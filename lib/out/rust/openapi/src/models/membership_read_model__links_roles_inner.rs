...
pub struct MembershipReadModelLinksRolesInner {
...
impl MembershipReadModelLinksRolesInner {
    pub fn new(href: Option<serde_json::Value>) -> MembershipReadModelLinksRolesInner {
        MembershipReadModelLinksRolesInner {
            href,
            title: None,
            templated: None,
            method: None,
