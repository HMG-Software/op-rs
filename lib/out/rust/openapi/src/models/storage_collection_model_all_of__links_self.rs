...
pub struct StorageCollectionModelAllOfLinksSelf {
...
impl StorageCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> StorageCollectionModelAllOfLinksSelf {
