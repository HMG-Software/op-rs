...
pub struct HelpTextCollectionModelAllOfLinksSelf {
...
impl HelpTextCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> HelpTextCollectionModelAllOfLinksSelf {
        HelpTextCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
