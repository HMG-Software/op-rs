...
pub struct MembershipWriteModelMetaNotificationMessage {
...
impl MembershipWriteModelMetaNotificationMessage {
    pub fn new(format: Option<Format>) -> MembershipWriteModelMetaNotificationMessage {
