...
pub struct MembershipReadModelLinksUpdate {
...
impl MembershipReadModelLinksUpdate {
    pub fn new(href: Option<serde_json::Value>) -> MembershipReadModelLinksUpdate {
        MembershipReadModelLinksUpdate {
            href,
            title: None,
            templated: None,
            method: None,
