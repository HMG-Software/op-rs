...
pub struct StorageReadModelLinksOauthClientCredentials {
...
impl StorageReadModelLinksOauthClientCredentials {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksOauthClientCredentials {
