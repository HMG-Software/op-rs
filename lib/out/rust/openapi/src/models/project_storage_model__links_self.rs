...
pub struct ProjectStorageModelLinksSelf {
...
impl ProjectStorageModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksSelf {
        ProjectStorageModelLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
