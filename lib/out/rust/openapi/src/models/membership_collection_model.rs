...
pub struct MembershipCollectionModel {
    ...
    #[serde(rename = "pageSize", deserialize_with = "Option::deserialize")]
    pub page_size: Option<serde_json::Value>,
    /// The page number that is requested from paginated collection.
    #[serde(rename = "offset", deserialize_with = "Option::deserialize")]
    pub offset: Option<serde_json::Value>,
    #[serde(rename = "_embedded")]
    pub _embedded: Box<models::MembershipCollectionModelAllOfEmbedded>,
}

impl MembershipCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::PaginatedCollectionModelAllOfLinks, page_size: Option<serde_json::Value>, offset: Option<serde_json::Value>, _embedded: models::MembershipCollectionModelAllOfEmbedded) -> MembershipCollectionModel {
