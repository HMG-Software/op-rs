...
pub struct ProjectStorageModelLinksProjectFolder {
...
impl ProjectStorageModelLinksProjectFolder {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksProjectFolder {
        ProjectStorageModelLinksProjectFolder {
            href,
            title: None,
            templated: None,
            method: None,
