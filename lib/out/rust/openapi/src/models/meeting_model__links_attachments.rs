...
pub struct MeetingModelLinksAttachments {
...
impl MeetingModelLinksAttachments {
    pub fn new(href: Option<serde_json::Value>) -> MeetingModelLinksAttachments {
        MeetingModelLinksAttachments {
            href,
            title: None,
            templated: None,
            method: None,
