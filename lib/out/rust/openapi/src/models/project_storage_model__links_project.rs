...
pub struct ProjectStorageModelLinksProject {
...
impl ProjectStorageModelLinksProject {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksProject {
        ProjectStorageModelLinksProject {
            href,
            title: None,
            templated: None,
            method: None,
