...
pub struct WorkPackageModelLinksAncestorsInner {
...
impl WorkPackageModelLinksAncestorsInner {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAncestorsInner {
