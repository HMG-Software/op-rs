...
pub struct ProjectStorageCollectionModelAllOfLinksSelf {
...
impl ProjectStorageCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageCollectionModelAllOfLinksSelf {
        ProjectStorageCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
