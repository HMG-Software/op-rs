...
pub struct WorkPackageModelLinksCustomActionsInner {
...
impl WorkPackageModelLinksCustomActionsInner {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksCustomActionsInner {
        WorkPackageModelLinksCustomActionsInner {
            href,
            title: None,
            templated: None,
            method: None,
