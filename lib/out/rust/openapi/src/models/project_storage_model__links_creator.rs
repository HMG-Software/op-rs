...
pub struct ProjectStorageModelLinksCreator {
...
impl ProjectStorageModelLinksCreator {
    pub fn new(href: Option<serde_json::Value>) -> ProjectStorageModelLinksCreator {
        ProjectStorageModelLinksCreator {
            href,
            title: None,
            templated: None,
            method: None,
