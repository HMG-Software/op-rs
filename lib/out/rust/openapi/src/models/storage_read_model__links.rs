...
pub struct StorageReadModelLinks {
    ...
    #[serde(rename = "oauthClientCredentials", skip_serializing_if = "Option::is_none")]
    pub oauth_client_credentials: Option<Box<models::StorageReadModelLinksOauthClientCredentials>>,
}

impl StorageReadModelLinks {
    pub fn new(param_self: models::StorageReadModelLinksSelf, r#type: models::StorageReadModelLinksType, origin: models::StorageReadModelLinksOrigin, open: models::StorageReadModelLinksOpen, authorization_state: models::StorageReadModelLinksAuthorizationState) -> StorageReadModelLinks {
