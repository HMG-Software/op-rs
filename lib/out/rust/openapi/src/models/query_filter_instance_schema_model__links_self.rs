...
pub struct QueryFilterInstanceSchemaModelLinksSelf {
...
impl QueryFilterInstanceSchemaModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> QueryFilterInstanceSchemaModelLinksSelf {
