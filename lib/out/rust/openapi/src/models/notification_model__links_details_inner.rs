...
pub struct NotificationModelLinksDetailsInner {
...
impl NotificationModelLinksDetailsInner {
    pub fn new(href: Option<serde_json::Value>) -> NotificationModelLinksDetailsInner {
