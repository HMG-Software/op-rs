...
pub struct CollectionModelLinksSelf {
...
impl CollectionModelLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> CollectionModelLinksSelf {
        CollectionModelLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
