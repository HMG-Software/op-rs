...
pub struct ProjectCollectionModelAllOfLinksSelf {
...
impl ProjectCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> ProjectCollectionModelAllOfLinksSelf {
        ProjectCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
