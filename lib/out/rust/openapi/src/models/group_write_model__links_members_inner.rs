...
pub struct GroupWriteModelLinksMembersInner {
...
impl GroupWriteModelLinksMembersInner {
    pub fn new(href: Option<serde_json::Value>) -> GroupWriteModelLinksMembersInner {
        GroupWriteModelLinksMembersInner {
            href,
            title: None,
            templated: None,
            method: None,
