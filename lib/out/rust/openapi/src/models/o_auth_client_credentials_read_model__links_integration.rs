...
pub struct OAuthClientCredentialsReadModelLinksIntegration {
...
impl OAuthClientCredentialsReadModelLinksIntegration {
    pub fn new(href: Option<serde_json::Value>) -> OAuthClientCredentialsReadModelLinksIntegration {
        OAuthClientCredentialsReadModelLinksIntegration {
            href,
            title: None,
            templated: None,
            method: None,
