...
pub struct CategoryModelLinksDefaultAssignee {
...
impl CategoryModelLinksDefaultAssignee {
    pub fn new(href: Option<serde_json::Value>) -> CategoryModelLinksDefaultAssignee {
