...
pub struct StorageWriteModelLinksType {
...
impl StorageWriteModelLinksType {
    pub fn new(href: Option<serde_json::Value>) -> StorageWriteModelLinksType {
        StorageWriteModelLinksType {
            href,
            title: None,
            templated: None,
            method: None,
