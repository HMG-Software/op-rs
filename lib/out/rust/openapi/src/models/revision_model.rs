...
pub struct RevisionModel {
    ...
    pub message: Box<models::RevisionModelMessage>,
...
impl RevisionModel {
    pub fn new(identifier: String, formatted_identifier: String, author_name: String, message: models::RevisionModelMessage, created_at: String) -> RevisionModel {
        RevisionModel {
            id: None,
            identifier,
