...
pub struct WatchersModel {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::WatchersModelAllOfLinks>,
    #[serde(rename = "_embedded")]
    pub _embedded: Box<models::WatchersModelAllOfEmbedded>,
}

impl WatchersModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::WatchersModelAllOfLinks, _embedded: models::WatchersModelAllOfEmbedded) -> WatchersModel {
        WatchersModel {
            _type,
            total,
            count,
