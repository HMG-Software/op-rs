...
pub struct WorkPackageModelLinksUpdateImmediately {
...
impl WorkPackageModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksUpdateImmediately {
