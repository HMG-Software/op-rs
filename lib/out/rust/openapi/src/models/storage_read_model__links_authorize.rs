...
pub struct StorageReadModelLinksAuthorize {
...
impl StorageReadModelLinksAuthorize {
    pub fn new(href: Option<serde_json::Value>) -> StorageReadModelLinksAuthorize {
        StorageReadModelLinksAuthorize {
            href,
            title: None,
            templated: None,
            method: None,
