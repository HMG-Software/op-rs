...
pub struct WorkPackageModelLinksAddFileLink {
...
impl WorkPackageModelLinksAddFileLink {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksAddFileLink {
