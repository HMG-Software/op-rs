...
pub struct GroupModelLinksUpdateImmediately {
...
impl GroupModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> GroupModelLinksUpdateImmediately {
