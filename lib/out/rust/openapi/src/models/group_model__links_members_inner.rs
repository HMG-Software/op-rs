...
pub struct GroupModelLinksMembersInner {
...
impl GroupModelLinksMembersInner {
    pub fn new(href: Option<serde_json::Value>) -> GroupModelLinksMembersInner {
        GroupModelLinksMembersInner {
            href,
            title: None,
            templated: None,
            method: None,
