...
pub struct VersionModelLinksDefiningProject {
...
impl VersionModelLinksDefiningProject {
    pub fn new(href: Option<serde_json::Value>) -> VersionModelLinksDefiningProject {
