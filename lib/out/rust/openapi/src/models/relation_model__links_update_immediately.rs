...
pub struct RelationModelLinksUpdateImmediately {
...
impl RelationModelLinksUpdateImmediately {
    pub fn new(href: Option<serde_json::Value>) -> RelationModelLinksUpdateImmediately {
