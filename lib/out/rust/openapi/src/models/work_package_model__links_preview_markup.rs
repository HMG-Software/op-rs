...
pub struct WorkPackageModelLinksPreviewMarkup {
...
impl WorkPackageModelLinksPreviewMarkup {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksPreviewMarkup {
