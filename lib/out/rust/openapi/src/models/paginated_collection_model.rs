...
impl PaginatedCollectionModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::PaginatedCollectionModelAllOfLinks, page_size: i32, offset: i32) -> PaginatedCollectionModel {
