...
pub struct TimeEntryModelLinksSchema {
...
impl TimeEntryModelLinksSchema {
    pub fn new(href: Option<serde_json::Value>) -> TimeEntryModelLinksSchema {
        TimeEntryModelLinksSchema {
            href,
            title: None,
            templated: None,
            method: None,
