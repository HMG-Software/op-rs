...
pub struct UserCollectionModelAllOfLinksSelf {
...
impl UserCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> UserCollectionModelAllOfLinksSelf {
