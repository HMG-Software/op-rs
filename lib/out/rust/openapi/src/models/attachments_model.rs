...
pub struct AttachmentsModel {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::AttachmentsModelAllOfLinks>,
    #[serde(rename = "_embedded")]
    pub _embedded: Box<models::AttachmentsModelAllOfEmbedded>,
}

impl AttachmentsModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::AttachmentsModelAllOfLinks, _embedded: models::AttachmentsModelAllOfEmbedded) -> AttachmentsModel {
        AttachmentsModel {
            _type,
            total,
            count,
