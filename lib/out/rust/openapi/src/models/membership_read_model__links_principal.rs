...
pub struct MembershipReadModelLinksPrincipal {
...
impl MembershipReadModelLinksPrincipal {
    pub fn new(href: Option<serde_json::Value>) -> MembershipReadModelLinksPrincipal {
