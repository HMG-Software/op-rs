...
impl NotificationModelLinks {
    pub fn new(param_self: models::NotificationModelLinksSelf, project: models::NotificationModelLinksProject, actor: models::NotificationModelLinksActor, resource: models::NotificationModelLinksResource, activity: models::NotificationModelLinksActivity, details: Vec<models::NotificationModelLinksDetailsInner>) -> NotificationModelLinks {
        NotificationModelLinks {
