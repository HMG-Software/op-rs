...
pub struct MeetingModelLinksAddAttachment {
...
impl MeetingModelLinksAddAttachment {
    pub fn new(href: Option<serde_json::Value>) -> MeetingModelLinksAddAttachment {
        MeetingModelLinksAddAttachment {
            href,
            title: None,
            templated: None,
            method: None,
