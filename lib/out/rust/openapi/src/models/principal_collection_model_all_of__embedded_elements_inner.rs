...
impl PrincipalCollectionModelAllOfEmbeddedElementsInner {
    pub fn new(_type: Option<Type>, id: Option<serde_json::Value>, name: Option<serde_json::Value>, _links: models::PlaceholderUserModelAllOfLinks, avatar: Option<serde_json::Value>) -> PrincipalCollectionModelAllOfEmbeddedElementsInner {
