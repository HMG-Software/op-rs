...
impl StorageFilesModel {
    pub fn new(_type: Type, files: Vec<models::StorageFileModel>, parent: models::StorageFilesModelParent, ancestors: Vec<models::StorageFileModel>, _links: models::StorageFileModelAllOfLinks) -> StorageFilesModel {
        StorageFilesModel {
            _type,
            files,
