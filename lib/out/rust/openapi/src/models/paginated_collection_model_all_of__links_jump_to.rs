...
pub struct PaginatedCollectionModelAllOfLinksJumpTo {
...
impl PaginatedCollectionModelAllOfLinksJumpTo {
    pub fn new(href: Option<serde_json::Value>) -> PaginatedCollectionModelAllOfLinksJumpTo {
        PaginatedCollectionModelAllOfLinksJumpTo {
            href,
            title: None,
            templated: None,
            method: None,
