...
pub struct PlaceholderUserCollectionModelAllOfLinksSelf {
...
impl PlaceholderUserCollectionModelAllOfLinksSelf {
    pub fn new(href: Option<serde_json::Value>) -> PlaceholderUserCollectionModelAllOfLinksSelf {
        PlaceholderUserCollectionModelAllOfLinksSelf {
            href,
            title: None,
            templated: None,
            method: None,
