...
impl FileLinkCollectionWriteModel {
    pub fn new(_type: Option<Type>, total: Option<serde_json::Value>, count: Option<serde_json::Value>, _links: models::CollectionModelLinks, _embedded: models::FileLinkCollectionWriteModelAllOfEmbedded) -> FileLinkCollectionWriteModel {
