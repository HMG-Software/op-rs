...
pub struct WorkPackageModelLinksRemoveWatcher {
...
impl WorkPackageModelLinksRemoveWatcher {
    pub fn new(href: Option<serde_json::Value>) -> WorkPackageModelLinksRemoveWatcher {
