...
**status** | Option<[**serde_json::Value**](.md)> | The current activation status of the placeholder user.  # Conditions  - User has `manage_placeholder_user` permission globally | [optional]
